...
Uses a single shared pretrained ``ESMC.from_pretrained("esmc_300m")`` with no
LoRA adapters. LoRA-family shards are a separate export
(``src.representations.export_lora_esmc``). See ``data/README.md``.
...
class ExportConfig:
    ...
    embed_root: str = str(REPO / "data/embeddings/raw_esmc_300m")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--reference-root",
        default=str(REPO / "data/embeddings/lora_esmc_300m"),
