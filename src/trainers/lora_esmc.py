...
class RunConfig:
    ...
    checkpoint_root: str = str(REPO / "outputs/checkpoints/esm_vicreg_finetuned_complete")
    output_root: str = str(REPO / "outputs/esm_vicreg_finetuned_complete")
    figure_root: str = str(REPO / "figures/esm_vicreg_finetuned_complete")

    finetuned_embed_root: str = str(REPO / "data/embeddings/lora_esmc_300m")
    pretrained_embed_root: str = str(REPO / "data/embeddings/raw_esmc_300m")
    finetuned_immrep_shard_dir: str = str(REPO / "data/embeddings/lora_esmc_300m/immrep_test")
...
def main() -> None:
    ...
    # Free train shard RAM before final eval (caches can be ~tens of GB).
    train_ds.clear_shard_cache()
    val_ds_epoch.clear_shard_cache()
