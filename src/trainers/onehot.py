#!/usr/bin/env python3
"""One-hot VICReg training loop.

Core model, loss and scoring definitions live in src/models/. This module
handles paper-specific data loading, training, checkpoint selection and
latent export.

Rows produced from the same complete-chain CSVs:
...
# Single definition of the loss and score, shared with the ESMC trainers.
from src.models.scoring import score_from_vectors  # noqa: E402
from src.models.vicreg import (  # noqa: E402
    plain_vicreg_loss,
    vicreg_covariance,
    vicreg_variance,
)
...
class RunConfig:
    ...
    checkpoint_root: str = str(REPO / "outputs/checkpoints/onehot_vicreg_complete")
    output_root: str = str(REPO / "outputs/onehot_vicreg_complete")
    figure_root: str = str(REPO / "figures/onehot_vicreg_complete")
